...
q7_t col_buffer[2304];
q7_t scratch_buffer[28800];
...
void run_nn(q7_t* input_data, q7_t* output_data) {
  ...
  arm_convolve_HWC_q7_basic(total_buffer, CONV2_IN_DIM, CONV2_IN_CH, conv2_wt, CONV2_OUT_CH, CONV2_KER_DIM, CONV2_PAD, CONV2_STRIDE, conv2_bias, CONV2_BIAS_LSHIFT, CONV2_OUT_RSHIFT, p_total_buffer, CONV2_OUT_DIM, (q15_t*)col_buffer, NULL);
  ...
  arm_convolve_HWC_q7_basic(total_buffer, CONV3_IN_DIM, CONV3_IN_CH, conv3_wt, CONV3_OUT_CH, CONV3_KER_DIM, CONV3_PAD, CONV3_STRIDE, conv3_bias, CONV3_BIAS_LSHIFT, CONV3_OUT_RSHIFT, p_total_buffer, CONV3_OUT_DIM, (q15_t*)col_buffer, NULL);
